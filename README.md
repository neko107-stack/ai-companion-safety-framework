...
| [`src/safety/crisis-detection.test.js`](./src/safety/crisis-detection.test.js) | 危機検知ロジックのユニットテスト（Jest） |
...
#   detectCrisis — Layer 1（CRITICAL / HIGH / MODERATE / MILD / NONE）
#   detectCognitiveDistortions — Layer 2（CBT認知の歪み）
#   detectEmotionalState — Layer 3（DBT感情状態 + Joiner理論）
#   detectCrisisFull — Layer 1+2+3 統合
#   detectLongitudinalChange — Layer 4（ウェルビーイングトレンド）
#   isDependencyRisk / isAbusive / エッジケース
```
